<?
define(TITLE, 'Yiff Dungeon Chan');		//Ekkeberg Dungeon
...
define(ADMIN_PASS, 'jegelskerkuk');	//Janitor password  (CHANGE THIS YO)
...
define(BR_CHECK, 15);		//Max lines per post (25 = no limit)
